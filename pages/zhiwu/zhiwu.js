// miniprogram/pages/zhiwu/zhiwu.js
const app = getApp()
...
Page({
   ...
   */
  data: {
    imgPath: '/resources/images/AIPage/leaves.png',
    items: null,
    access_token:null,
  },
  ...
  scanImageInfo: function (imageData) {
    var that = this;
    const detectUrl = `https://aip.baidubce.com/rest/2.0/image-classify/v1/plant?access_token=${getApp().globalData.baiduToken}`;
