// miniprogram/pages/wupin/wupin.js
const app = getApp()
Page({
   ...
   */
  data: {
    imgPath: '/resources/images/AIPage/items.png',
    items: null,
  },
  ...
  scanImageInfo: function (imageData) {
    var that = this;
    const detectUrl = `https://aip.baidubce.com/rest/2.0/image-classify/v2/advanced_general?access_token=${getApp().globalData.baiduToken}`;
